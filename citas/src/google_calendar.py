#Para manejar el calendario de google
...
class GoogleCalendar:
    def __init__(self, cedentials,idcalendar):
        #autenticamos
        self.credentials = cedentials
    ...
    def create_event(self, name_event, start_time,end_time,timezone,attendes=None):
        ...
        try: 
            ...
            raise Exception(f"Un error al crear: {error}")
    ...
    def get_event_start_time(self,date):
        ...
        for event in events:
            ...
            hours_munuts = parsed_start_time.strftime("%H:%M")
            start_times.append(hours_munuts)
